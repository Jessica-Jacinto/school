...
//    new Person[numPeople];
    ...
    Person.Gender _gender,int _weight)
    {
    ...
    Person(String _name, Person.Gender _gender, int _weight)
    {
        name = _name;
        gender = _gender;
        weight = _weight;
    ...
    public void setGender(Person.Gender _gender)
    {
        gender = _gender;
    } 
    ...
    public static void printNamesByGender(Person.Gender _gender)
    {
        System.out.println("==printNamesByGender===" + _gender);
        for(Person temp : people)
        {
